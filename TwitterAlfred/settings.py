"""
Django settings for TwitterAlfred project.
...
SECRET_KEY = 'qa^f*ehojlw+3bd%i!3je#$kbhexdzv=t!ud-x)h#99x!&^+q9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.user_online',
            ],
        },
    },
]

WSGI_APPLICATION = 'TwitterAlfred.wsgi.application'


# Database
# https://docs.djangoproject.com/en/2.0/ref/settings/#databases
BASEURL = "https://twitter-alfred.herokuapp.com"
APIS = {}
